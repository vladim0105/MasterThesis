...
\begin{figure}[H]
    ...
    \caption[Frame Repeat Anomaly]{Anomaly output during the repeating frame, the start of the frame repeat is marked with red text.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[No Frame Repeat Anomaly]{Anomaly output when there is no frame repeating, where it should have repeated is marked in red.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Frame Repeat No MTP Anomaly]{Anomaly output during the repeating frame, the start of the frame repeat is marked with red text. This time without multistep temporal patterns.}
...
\begin{figure}[H]
    ...
    \caption[Sperm Example Frame]{Example frame from a sperm video and its corresponding segmentation.}
\end{figure}

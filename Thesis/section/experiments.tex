...
\end{figure}
It is important to note that the data itself is noisy, and that it is not possible for the Grid HTM to learn any meaningful pattern. Because the data is noisy, the mean was used as the aggregation function.

...
The video to be used is part of the VIRAT\cite{VIRAT} video dataset, and was selected due to its long duration and stationary camera (\autoref{fig:selected_frame}).
\par
...
\begin{figure}[H]
    ...
    \caption{Anomaly output when the video is frozen in time, the start of the freeze is marked with red text.}
\end{figure}

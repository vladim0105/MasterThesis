...
One of the key principles of HTM theory is that it must be biologically plausible. Every development within HTM theory follows this theory, and it should therefore be expected that Grid HTM does so as well.
\par

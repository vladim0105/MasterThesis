...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption[Distribution of Active Pixels]{Distribution of number of active pixels within a cell of size $12\times 12$, it can also be observed that it would benefit from having a minimum sparsity requirement of $\sim 5$.}
...
One of the key principles of HTM theory is that it must be biologically plausible~\cite{BAMI}. Every development within HTM theory follows this theory, and it should therefore be expected that Grid HTM does so as well.
\par
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption[Grid HTM Environments]{Examples of environments that Grid HTM could help monitor. Image taken from the VIRAT\cite{VIRAT} dataset.}
\end{figure}

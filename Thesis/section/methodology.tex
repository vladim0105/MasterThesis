...
\begin{itemize}
    \item \textbf{Semantically similar data should result in \glspl*{sdr} with overlapping active bits}. In this example, a car at one position will produce an SDR with a high amount of overlapping bits as another car at a similar position in the input image.

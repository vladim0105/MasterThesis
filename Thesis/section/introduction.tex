...
\par
Finally, it needs to be noted that Numenta, which is the company behind HTM, is a private for-profit company. This means that it is in their best interest to present HTM as a highly functional and powerful machine learning algorithm. In order to uncover the weaknesses of HTM, it is required to have a deep understanding of the algorithm which is typically not achieved until towards the end of the thesis. Therefore, a lot of changes have had to be made late in the thesis due to the uncovering of weaknesses in HTM.

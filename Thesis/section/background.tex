...
\begin{figure}[H]
    ...
    \caption{The feature map activations in the 10th layer of ResNet18\cite{resnet}. This is only 16 of them, there are many more in the layer that are not shown.}
\end{figure}
\par

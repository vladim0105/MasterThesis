...
\begin{figure}[H]
    ...
    \caption{Comparison of neurons \protect\cite{htm_neurons}: A) Traditional Machine Learning, B) Biological, C) HTM. Source: \cite{BAMI}}
...
\begin{figure}[H]
    ...
    \caption{Visualization of a cyclical date encoder, which is currently encoding Friday. Source: \cite{BAMI}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{The feature map activations in the 10th layer of ResNet18. This is only 16 of them, there are many more in the layer that are not shown.}
\end{figure}
\par
...
\begin{figure}[H]
    ...
    \caption{Visualization of the SP and the potential pool of one of its columns. Source: \cite{htm_sp_presentation}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Visualization of the TM and the three states. Active in black, predictive in gray, and inactive in white. Source: \cite{BAMI}}
\end{figure}

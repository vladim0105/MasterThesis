...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Grad-CAM visualization for the labels "dog" and "cat". (Source:~\cite{GradCamExample})}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Comparison of neurons: Traditional Machine Learning (A), Biological Neuron (B), HTM Neuron (C). Source:~\cite{BAMI}}
